...
{% include figure image_path="/assets/images/research/FIG6-SurfOceCurrents.png" alt="eifls" caption="Representación esquemática de las corrientes oceánicas superficiales impulsadas por el viento. Fuente oceanmotion.org." %}
...
{% include figure image_path="/assets/images/research/FIG7-THC.png" alt="eifls" caption="Mapa esquemático de la circulación termohalina global. Tomado de Rahmstorf et al 2006. "%}
