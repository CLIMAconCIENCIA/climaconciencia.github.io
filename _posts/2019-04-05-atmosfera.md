...
{% include figure image_path="/assets/images/research/FIG3-AtmCircul.png" width="400" alt="eifls" caption=" Representación esquemática de las principales estructuras a gran escala de la circulación atmosférica. Tomado de Lutgens et al. 2001."  %}
...
{% include figure image_path="/assets/images/research/FIG4-ITCZ-H-L.png" alt="Adaptado de geog.uoregon.edu" caption="Centros prevalentes de presión atmosférica baja (L) baja y alta (H), promediadas durante 1959-1997 en enero (a) y julio (b), con el nombre de Los más importantes. La línea roja representa la posición ITCZ." %}
